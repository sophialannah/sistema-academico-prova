...
public class AlunoResource {
	...
	public ResponseEntity<Aluno> insert(@RequestBody Aluno a, UriComponentsBuilder uriBuilder) {

		a = servico.insert(a);
		URI uri = uriBuilder.path("/alunos/{id}").buildAndExpand(a.getIdaluno()).toUri();
